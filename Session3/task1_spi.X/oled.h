...
static FILE oled_stream_font4 =
    FDEV_SETUP_STREAM(oled_putchar4, NULL, _FDEV_SETUP_WRITE);
static FILE oled_stream_font5 =
    FDEV_SETUP_STREAM(oled_putchar5, NULL, _FDEV_SETUP_WRITE);
static FILE oled_stream_font8 =
    FDEV_SETUP_STREAM(oled_putchar8, NULL, _FDEV_SETUP_WRITE);
